        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-4">
            <img
              ...
              className="h-12"
            />
            <span className="px-3 py-1 text-xs border border-slate-600 rounded-full text-slate-300">
              INTERNAL PORTAL
            </span>
          </div>
          <div className="flex items-center gap-4">
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="flex items-center gap-3 px-3 py-1.5 hover:bg-slate-800 rounded transition-colors"
              >
                {avatarUrl ? (
                  <img
                    src={avatarUrl}
                  ...
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center border-2 border-slate-600">
