      ...
      <div className="w-full max-w-md bg-gradient-to-br from-slate-950 to-slate-950 border border-slate-800 rounded-3xl shadow-2xl p-8">
        {!showSetup ? (
          <>
            ...
            <button
              onClick={signOut}
              className="w-full mt-4 px-4 py-2.5 bg-slate-800 hover:bg-slate-700 text-slate-300 font-medium rounded-full transition-colors flex items-center justify-center gap-2"
            >
